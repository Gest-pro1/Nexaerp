...
{/* tela de sucesso para quando o usuario alterar a senha  com sucesso */}
...
<div className=" flex flex-col text-center gap-4">
  ...
  <p className=" font-medium sm:text-sm text-gray-500">
   Sua senha foi atualizada. Agora você pode <br /> acessa o sistema com sua nova credencial.
  </p>
